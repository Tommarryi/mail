...
public class MailTest03 {
    ...
    public static void main(String[] args) throws MessagingException {
        ...
        transport.connect("smtp.163.com","lsy15595078920","ZEAQANCTKMIVSQBW");
        // 4. 设置Message邮件对象
    ...
    private static Message createAttachMail(Session session) throws MessagingException {
        ...
        // 设置邮件的发送人
        message.setFrom("lsy15595078920@163.com");
        // 设置邮件的接收人 （发件人和收件人是同一个账户，邮箱也是一样的）
        message.setRecipient(Message.RecipientType.TO, new InternetAddress("lsy15595078920@163.com"));
        // 设置邮件的主题
        ...
        // 本地文件
        DataHandler df = new DataHandler(new FileDataSource("C:\\idea-code\\free\\pom.xml"));
        // 将本地文件设置到附件对象中
